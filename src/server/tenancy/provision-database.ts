 ...
 */
export const TENANT_SCHEMA_VERSION = "2026.09.2";
...
async function applySchema(
  ...
  try {
    // One statement per call is not needed: node-postgres sends a multi-command
    // string in an implicit transaction, so a failure part-way leaves no
    // half-applied schema.
